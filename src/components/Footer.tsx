    ...
    <footer className="bg-aries-dark py-16 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#services" className="text-aries-light/70 hover:text-[#FF5000] transition-colors">Services</a></li>
              <li><a href="#team" className="text-aries-light/70 hover:text-[#FF5000] transition-colors">Team</a></li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center">
          <p className="text-aries-light/60">&copy; {new Date().getFullYear()} Federation Global. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
